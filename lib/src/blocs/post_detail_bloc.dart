...
class PostDetailBloc {
  ...
  Observable<Post> get post => _postFetcher.stream;
  ...
  Observable<CommentsModel> get comments => _commentsFetcher.stream;
  Observable<bool> get hasMoreCommets => _hasMoreCommentsFetcher.stream;
