...
class AvailableVariation {
  ...
  factory AvailableVariation.fromJson(Map<String, dynamic> json) => AvailableVariation(
    ...
    //displayRegularPrice: json["display_regular_price"] == null ? null : json["display_regular_price"],
    image: json["image"] == null ? null : AvailableVariationImage.fromJson(json["image"]),
