                ...
                Align(
                  child: Column(
                    children: <Widget>[
                      Text("Virtual"),
                      Switch.adaptive(
                        value: variationProduct.virtual == true ? true : false,
                        onChanged: (bool value) {
                          setState(() {
                            variationProduct.virtual =
                            value  ? true : false;
                          });
                        },
                      ),
                ...
                Align(
                  child: Column(
                    children: <Widget>[
                      Text("Manage Stock"),
                      Switch.adaptive(
                        value: variationProduct.manageStock == true
                            ? true
                            : false,
                        onChanged: (bool value) {
                          setState(() {
                            variationProduct.manageStock =
                ...
                child: AccentButton(
                  onPressed: () {
                    if (_formKey.currentState.validate()) {
                      ...
                      widget.vendorBloc.addVariationProduct(widget.product.id, variationProduct);
