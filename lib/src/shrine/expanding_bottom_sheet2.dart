...
class _ExpandingBottomSheetState extends State<ExpandingBottomSheet>
      ...
      thumbnails = Column(
        children: [
          AnimatedPadding(
            ...
            child: const Icon(FlutterIcons.shopping_cart_fea),
  ...
  Widget _buildCart(BuildContext context) {
    ...
    final numProducts = model.shoppingCart.cartContents.length;
    //final totalCartQuantity = model.totalCartQuantity;
    final totalCartQuantity = model.shoppingCart.cartContents.length;
    ...
    final childWithInteraction = productPageIsVisible(context)
        ? Semantics(
      button: true,
      label: totalCartQuantity.toString(),
...
class ExtraProductsNumber extends StatelessWidget {
  ...
  Widget _buildOverflow(AppStateModel model, BuildContext context) {
    if (model.shoppingCart.cartContents.length <= _maxThumbnailCount) {
...
class _ListModel {
  _ListModel({
    ...
    Iterable<CartContent> initialItems,
        ...
        _items = initialItems?.toList() ?? <CartContent>[];

  final GlobalKey<AnimatedListState> listKey;
  final Widget Function(CartContent, BuildContext, Animation<double>)
  removedItemBuilder;
