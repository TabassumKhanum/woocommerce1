                  ...
                  percentOff != 0 ? Positioned(
                    ...
                    child: Card(
                      ...
                      child: Container(
                        ...
                        child: Text(percentOff.toString() + '% OFF', style: Theme.of(context).accentTextTheme.body2.copyWith(
                            fontSize: 12.0
                        ),),
                      ),
                    ),
                    ...
                    Column(
                      ...
                      children: <Widget>[
                        ...
                        Row(
                          ...
                          children: <Widget>[
                            Text(onSale ? _parseHtmlString(product.formattedSalesPrice)
                    ...
                    Row(
                      children: <Widget>[
                        RatingBar(
                          ...
                          unratedColor: Theme.of(context).hintColor.withOpacity(0.3),
